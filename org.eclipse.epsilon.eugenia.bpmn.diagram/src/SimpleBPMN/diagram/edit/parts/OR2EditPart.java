 ...
 * @generated
 */
public class OR2EditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new SimpleBPMN.diagram.edit.policies.OR2ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof SimpleBPMN.diagram.edit.parts.ORName2EditPart) {
	...
	public class ORFigure extends SVGFigure {
		 ...
		 */
		public ORFigure() {
			this.setURI("platform:/plugin/org.eclipse.epsilon.eugenia.bpmn/svg/or-gateway.svg");
