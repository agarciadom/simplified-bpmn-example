 ...
 * <ul>
 *   <li>{@link SimpleBPMN.impl.EventImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventImpl extends FlowObjectImpl implements Event {
	...
	public void setType(EventType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleBPMNPackage.EVENT__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimpleBPMNPackage.EVENT__TYPE:
				return getType();
		}
