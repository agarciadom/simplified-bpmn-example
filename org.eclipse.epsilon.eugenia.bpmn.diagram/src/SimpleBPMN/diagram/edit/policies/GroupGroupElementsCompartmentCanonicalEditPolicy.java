 ...
 * @generated
 */
public class GroupGroupElementsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<SimpleBPMN.diagram.part.SimpleBPMNNodeDescriptor> childDescriptors = SimpleBPMN.diagram.part.SimpleBPMNDiagramUpdater
				.getGroupGroupElementsCompartment_7001SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<SimpleBPMN.diagram.part.SimpleBPMNNodeDescriptor> childDescriptors = SimpleBPMN.diagram.part.SimpleBPMNDiagramUpdater
				.getGroupGroupElementsCompartment_7001SemanticChildren((View) getHost()
						.getModel());
