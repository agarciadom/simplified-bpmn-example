...
public class SequenceFlowReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof SimpleBPMN.SequenceFlow) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return SimpleBPMN.diagram.edit.policies.SimpleBPMNBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistSequenceFlow_4002(container,
	 ...
	 * @generated
	 */
	protected SimpleBPMN.SequenceFlow getLink() {
		return (SimpleBPMN.SequenceFlow) getElementToEdit();
	}
