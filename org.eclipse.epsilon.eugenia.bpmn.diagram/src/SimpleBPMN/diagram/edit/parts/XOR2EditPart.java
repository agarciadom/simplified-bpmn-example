 ...
 * @generated
 */
public class XOR2EditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new SimpleBPMN.diagram.edit.policies.XOR2ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof SimpleBPMN.diagram.edit.parts.XORName2EditPart) {
	...
	public class XORFigure extends SVGFigure {
		 ...
		 */
		public XORFigure() {
			this.setURI("platform:/plugin/org.eclipse.epsilon.eugenia.bpmn/svg/xor-gateway.svg");
