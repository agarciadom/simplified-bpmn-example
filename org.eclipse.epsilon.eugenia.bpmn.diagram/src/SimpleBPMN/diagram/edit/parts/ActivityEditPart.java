...
public class ActivityEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new SimpleBPMN.diagram.edit.policies.ActivityItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SimpleBPMN.diagram.edit.parts.ActivityNameEditPart) {
			((SimpleBPMN.diagram.edit.parts.ActivityNameEditPart) childEditPart)
