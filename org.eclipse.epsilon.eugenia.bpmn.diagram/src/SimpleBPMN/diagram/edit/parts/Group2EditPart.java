 ...
 * @generated
 */
public class Group2EditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new SimpleBPMN.diagram.edit.policies.Group2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SimpleBPMN.diagram.edit.parts.GroupGroupElementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getGroupElementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((SimpleBPMN.diagram.edit.parts.GroupGroupElementsCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SimpleBPMN.diagram.edit.parts.GroupGroupElementsCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getGroupElementsCompartmentFigure();
			pane.remove(((SimpleBPMN.diagram.edit.parts.GroupGroupElementsCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof SimpleBPMN.diagram.edit.parts.GroupGroupElementsCompartment2EditPart) {
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof SimpleBPMN.diagram.edit.parts.GroupName2EditPart) {
