 ...
 * @generated
 */
public class SimpleBPMNDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public SimpleBPMNDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof SimpleBPMN.diagram.navigator.SimpleBPMNDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((SimpleBPMN.diagram.navigator.SimpleBPMNDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new SimpleBPMN.diagram.navigator.SimpleBPMNDomainNavigatorItem(
