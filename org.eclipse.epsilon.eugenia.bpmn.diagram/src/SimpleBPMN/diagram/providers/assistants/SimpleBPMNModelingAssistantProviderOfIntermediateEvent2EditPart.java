 ...
 * @generated
 */
public class SimpleBPMNModelingAssistantProviderOfIntermediateEvent2EditPart
		extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((SimpleBPMN.diagram.edit.parts.IntermediateEvent2EditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			SimpleBPMN.diagram.edit.parts.IntermediateEvent2EditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(SimpleBPMN.diagram.edit.parts.IntermediateEvent2EditPart) sourceEditPart,
				targetEditPart);
	}
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((SimpleBPMN.diagram.edit.parts.IntermediateEvent2EditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			SimpleBPMN.diagram.edit.parts.IntermediateEvent2EditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(6);
		types.add(SimpleBPMN.diagram.providers.SimpleBPMNElementTypes.MessageFlow_4001);
		types.add(SimpleBPMN.diagram.providers.SimpleBPMNElementTypes.MessageFlow_4004);
		types.add(SimpleBPMN.diagram.providers.SimpleBPMNElementTypes.SequenceFlow_4002);
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(SimpleBPMN.diagram.edit.parts.IntermediateEvent2EditPart) targetEditPart,
				relationshipType);
	}
