...
public class DataObject2EditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new SimpleBPMN.diagram.edit.policies.DataObject2ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof SimpleBPMN.diagram.edit.parts.DataObjectName2EditPart) {
	 ...
	 * @generated
	 */
	public class DataObjectFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public DataObjectFigure() {
			this.setURI("platform:/plugin/org.eclipse.epsilon.eugenia.bpmn/svg/data-object.svg");
