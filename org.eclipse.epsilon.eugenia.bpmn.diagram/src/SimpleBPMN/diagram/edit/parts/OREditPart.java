...
public class OREditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SimpleBPMN.diagram.edit.policies.ORItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SimpleBPMN.diagram.edit.parts.ORNameEditPart) {
			((SimpleBPMN.diagram.edit.parts.ORNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureORLabelFigure());
			return true;
		}
		return false;
	}
