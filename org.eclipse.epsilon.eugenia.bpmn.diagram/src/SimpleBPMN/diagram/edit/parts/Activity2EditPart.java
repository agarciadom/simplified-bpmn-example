...
public class Activity2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new SimpleBPMN.diagram.edit.policies.Activity2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SimpleBPMN.diagram.edit.parts.ActivityName2EditPart) {
			((SimpleBPMN.diagram.edit.parts.ActivityName2EditPart) childEditPart)
