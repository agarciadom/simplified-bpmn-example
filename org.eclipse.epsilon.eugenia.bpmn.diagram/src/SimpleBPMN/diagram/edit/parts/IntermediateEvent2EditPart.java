 ...
 * @generated
 */
public class IntermediateEvent2EditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public IntermediateEvent2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new SimpleBPMN.diagram.edit.policies.IntermediateEvent2ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof SimpleBPMN.diagram.edit.parts.IntermediateEventName2EditPart) {
	 ...
	 * @generated
	 */
	public class IntermediateEventFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public IntermediateEventFigure() {
			this.setURI("platform:/plugin/org.eclipse.epsilon.eugenia.bpmn/svg/intermediate-event.svg");
