 ...
 * @generated
 */
public class GroupGroupElementsCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return SimpleBPMN.SimpleBPMNPackage.eINSTANCE.getGroup_Elements();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<SimpleBPMN.diagram.part.SimpleBPMNNodeDescriptor> childDescriptors = SimpleBPMN.diagram.part.SimpleBPMNDiagramUpdater
				.getGroupGroupElementsCompartment_7002SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<SimpleBPMN.diagram.part.SimpleBPMNNodeDescriptor> childDescriptors = SimpleBPMN.diagram.part.SimpleBPMNDiagramUpdater
				.getGroupGroupElementsCompartment_7002SemanticChildren((View) getHost()
						.getModel());
