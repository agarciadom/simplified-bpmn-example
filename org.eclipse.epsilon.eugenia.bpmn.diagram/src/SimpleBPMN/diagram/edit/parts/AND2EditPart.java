 ...
 * @generated
 */
public class AND2EditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new SimpleBPMN.diagram.edit.policies.AND2ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof SimpleBPMN.diagram.edit.parts.ANDName2EditPart) {
	...
	public class ANDFigure extends SVGFigure {
		 ...
		 */
		public ANDFigure() {
			this.setURI("platform:/plugin/org.eclipse.epsilon.eugenia.bpmn/svg/and-gateway.svg");
